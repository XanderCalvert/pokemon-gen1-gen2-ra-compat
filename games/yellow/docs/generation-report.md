...
[`generated/`](../french/generated/) output.
...
(78 = 76 achievements + 2 leaderboards, for both locales; Rich Presence is
...
and [`data/french_provenance_report.csv`](../french/data/french_provenance_report.csv)
...
in-game. **French has no equivalent regression check yet** — since no
French achievement has been run as a local achievement in RAIntegration,
there's nothing physically confirmed to diff against (see
[French's dynamic-testing.md](../french/docs/dynamic-testing.md)).
